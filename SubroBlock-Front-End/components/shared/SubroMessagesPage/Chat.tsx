    ...
    <div className="w-3/4">
      <div className="flex border-b p-3 items-center bg-background">
        ...
        <div className="flex ml-auto">
          ...
          <div className="leading-6 text-sm text-accent-foreground pr-6 pl-1 cursor-pointer"> Download Conversation Data</div>
        ...
        <div className="w-full px-5 flex flex-col justify-between">
          <div className="flex flex-col mt-5">
            <div className="flex justify-center">
              <div className="bg-background-secondary text-xs text-primary leading-3 p-1.5 mb-5 rounded-lg">Yesterday</div>
            </div>
              ...
              {chatMessages.map(({ id, name, avatar, description, isYouAuthor, time })=>{
                return (
                  <div key={id} className="mb-9 w-full">
                    ...
                    <div className={cn("flex justify-start pl-11 font-medium text-xs text-primary", isYouAuthor ? "justify-end pr-11" : null)}>{time}</div>
                  </div>
                )
              })}
            </div>
          </div>
          <div className="p-3 flex bg-background rounded-xl w-full items-center border border-secondary shadow-[0_2px_4px_0_rgba(0,0,0,0.03)]">
            <div className="mr-3">
